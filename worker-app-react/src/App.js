...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbw2d-L_g43BJ2bUbDUQkbXSq5b09Fd-36J223Z1NBghYkhDnfqdzNDax_XeCJ766wQ0Xg/exec";
  ...
  return (
    <Container maxWidth="md" sx={{ py: { xs: 2, sm: 4 } }}>
      <Typography variant="h4" component="h1" align="center" gutterBottom sx={{ mb: 4 }}>
        瑞宇水電 - 工作系統 <Box component="span" sx={{ color: 'red' }}>(v2)</Box>
      </Typography>
